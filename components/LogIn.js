...
export default function LogIn({setFloatWin, setUserProducts}) {
	...
	return (
		<div className={styles.logInMainContainer}>
			...
			<p className={styles.footer}>
				Olvidaste tu contraseña? Hace click{" "}
				<span onClick={() => setMessage("Aun no disponible, lo sentimos 😢")}>aquí</span>
			</p>
		</div>
	);
}
